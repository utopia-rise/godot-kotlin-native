...
fun String.isValidFloat(): Boolean = asGDString {
    nullSafe(Godot.gdnative.godot_string_is_valid_float)(it)
}
...
fun String.isValidHex(withPrefix: Boolean): Boolean = asGDString {
    nullSafe(Godot.gdnative.godot_string_is_valid_hex_number)(it, withPrefix)
}
...
fun String.isValidHtmlColor(): Boolean = asGDString {
    nullSafe(Godot.gdnative.godot_string_is_valid_html_color)(it)
}
