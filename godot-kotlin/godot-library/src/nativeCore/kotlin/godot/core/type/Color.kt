...
class Color(var r: Double, var g: Double, var b: Double, var a: Double = 1.0): Comparable<Color>, CoreType {
    ...
    companion object {
        ...
        fun fromRgbe9995(rgbe: Int) {
            val r = rgbe and 0x1ff
            val g = (rgbe shl 9) and 0x1ff
            val b = (rgbe shl 18) and 0x1ff
            val e = rgbe shl 27
            val m = pow(2.0, e - 15.0 - 9.0)
        }
    }
    ...
    fun isEqualApprox(other: Color) = godot.core.isEqualApprox(r, other.r)
        && godot.core.isEqualApprox(g, other.g)
        && godot.core.isEqualApprox(b, other.b)
    ...
    fun hex64(p_hex: Int): Color {
        val a: Double = (p_hex and 0xFFFF) / 65535.0
        var hex = p_hex shr 16
        val b: Double = (hex and 0xFFFF) / 65535.0
        hex = hex shr 16
        val g: Double = (hex and 0xFFFF) / 65535.0
        hex = hex shr 16
        val r: Double = (hex and 0xFFFF) / 65535.0
    ...
    operator fun times(rvalue: Double) = Color(r * rvalue, g * rvalue, b * rvalue, a * rvalue)
    operator fun div(other: Color) = Color(r / other.r, g / other.g, b / other.b, a / other.a)
    operator fun div(rvalue: Double) = Color(r / rvalue, g / rvalue, b / rvalue, a / rvalue)
