...
open class Viewport : Node {
    ...
    enum class ClearMode(val id: Int) {
        CLEAR_MODE_ALWAYS(0),
        CLEAR_MODE_NEVER(1),
    ...
    enum class DebugDraw(val id: Int) {
    ...
    enum class ShadowAtlasQuadrantSubdiv(val id: Int) {
    ...
    companion object {
        ...
        // Constants
        const val UPDATE_DISABLED: Int = 0
        const val UPDATE_ONCE: Int = 1
        const val UPDATE_WHEN_VISIBLE: Int = 2
        const val UPDATE_ALWAYS: Int = 3
        const val SHADOW_ATLAS_QUADRANT_SUBDIV_DISABLED: Int = 0
        const val SHADOW_ATLAS_QUADRANT_SUBDIV_1: Int = 1
        const val SHADOW_ATLAS_QUADRANT_SUBDIV_4: Int = 2
        const val SHADOW_ATLAS_QUADRANT_SUBDIV_16: Int = 3
        const val SHADOW_ATLAS_QUADRANT_SUBDIV_64: Int = 4
        const val SHADOW_ATLAS_QUADRANT_SUBDIV_256: Int = 5
        const val SHADOW_ATLAS_QUADRANT_SUBDIV_1024: Int = 6
        const val SHADOW_ATLAS_QUADRANT_SUBDIV_MAX: Int = 7
        const val RENDER_INFO_OBJECTS_IN_FRAME: Int = 0
        const val RENDER_INFO_VERTICES_IN_FRAME: Int = 1
        const val RENDER_INFO_MATERIAL_CHANGES_IN_FRAME: Int = 2
        const val RENDER_INFO_SHADER_CHANGES_IN_FRAME: Int = 3
        const val RENDER_INFO_SURFACE_CHANGES_IN_FRAME: Int = 4
        const val RENDER_INFO_DRAW_CALLS_IN_FRAME: Int = 5
        const val RENDER_INFO_MAX: Int = 6
        const val DEBUG_DRAW_DISABLED: Int = 0
        const val DEBUG_DRAW_UNSHADED: Int = 1
        const val DEBUG_DRAW_OVERDRAW: Int = 2
        const val DEBUG_DRAW_WIREFRAME: Int = 3
        const val MSAA_DISABLED: Int = 0
        const val MSAA_2X: Int = 1
        const val MSAA_4X: Int = 2
        const val MSAA_8X: Int = 3
        const val MSAA_16X: Int = 4
        const val USAGE_2D: Int = 0
        const val USAGE_2D_NO_SAMPLING: Int = 1
        const val USAGE_3D: Int = 2
        const val USAGE_3D_NO_EFFECTS: Int = 3
        const val CLEAR_MODE_ALWAYS: Int = 0
        const val CLEAR_MODE_NEVER: Int = 1
        const val CLEAR_MODE_ONLY_NEXT_FRAME: Int = 2
    ...
    open var msaa: Int
        get() = _icall_Int(getMsaaMethodBind, this.rawMemory)
        set(value) = _icall_Unit_Int(setMsaaMethodBind, this.rawMemory, value)
    ...
    open var usage: Int
        get() = _icall_Int(getUsageMethodBind, this.rawMemory)
        set(value) = _icall_Unit_Int(setUsageMethodBind, this.rawMemory, value)


    open var debugDraw: Int
        get() = _icall_Int(getDebugDrawMethodBind, this.rawMemory)
        set(value) = _icall_Unit_Int(setDebugDrawMethodBind, this.rawMemory, value)
    ...
    open var renderTargetClearMode: Int
        get() = _icall_Int(getClearModeMethodBind, this.rawMemory)
        set(value) = _icall_Unit_Int(setClearModeMethodBind, this.rawMemory, value)


    open var renderTargetUpdateMode: Int
    ...
    open var shadowAtlasSize: Int
        get() = _icall_Int(getShadowAtlasSizeMethodBind, this.rawMemory)
        set(value) = _icall_Unit_Int(setShadowAtlasSizeMethodBind, this.rawMemory, value)


    open var shadowAtlasQuad0: Int
        get() = _icall_Int_Int(getShadowAtlasQuadrantSubdivMethodBind, this.rawMemory, 0)
        set(value) = _icall_Unit_Int_Int(setShadowAtlasQuadrantSubdivMethodBind, this.rawMemory, 0, value)


    open var shadowAtlasQuad1: Int
        get() = _icall_Int_Int(getShadowAtlasQuadrantSubdivMethodBind, this.rawMemory, 1)
        set(value) = _icall_Unit_Int_Int(setShadowAtlasQuadrantSubdivMethodBind, this.rawMemory, 1, value)


    open var shadowAtlasQuad2: Int
        get() = _icall_Int_Int(getShadowAtlasQuadrantSubdivMethodBind, this.rawMemory, 2)
        set(value) = _icall_Unit_Int_Int(setShadowAtlasQuadrantSubdivMethodBind, this.rawMemory, 2, value)


    open var shadowAtlasQuad3: Int
        get() = _icall_Int_Int(getShadowAtlasQuadrantSubdivMethodBind, this.rawMemory, 3)
        set(value) = _icall_Unit_Int_Int(setShadowAtlasQuadrantSubdivMethodBind, this.rawMemory, 3, value)
    ...
    open fun setClearMode(mode: Int) {
        _icall_Unit_Int(setClearModeMethodBind, this.rawMemory, mode)
    }
    ...
    open fun getClearMode(): Viewport.ClearMode {
        return Viewport.ClearMode.fromInt(_icall_Int(getClearModeMethodBind, this.rawMemory))
    }
    ...
    open fun getUpdateMode(): Viewport.UpdateMode {
        return Viewport.UpdateMode.fromInt(_icall_Int(getUpdateModeMethodBind, this.rawMemory))
    }


    private val setMsaaMethodBind: CPointer<godot_method_bind> by lazy { getMB("Viewport", "set_msaa") }
    open fun setMsaa(msaa: Int) {
        _icall_Unit_Int(setMsaaMethodBind, this.rawMemory, msaa)
    }


    private val getMsaaMethodBind: CPointer<godot_method_bind> by lazy { getMB("Viewport", "get_msaa") }
    open fun getMsaa(): Viewport.MSAA {
        return Viewport.MSAA.fromInt(_icall_Int(getMsaaMethodBind, this.rawMemory))
    }
    ...
    open fun setUsage(usage: Int) {
        _icall_Unit_Int(setUsageMethodBind, this.rawMemory, usage)
    }
    ...
    open fun getUsage(): Viewport.Usage {
        return Viewport.Usage.fromInt(_icall_Int(getUsageMethodBind, this.rawMemory))
    }


    private val setDebugDrawMethodBind: CPointer<godot_method_bind> by lazy { getMB("Viewport", "set_debug_draw") }
    open fun setDebugDraw(debugDraw: Int) {
        _icall_Unit_Int(setDebugDrawMethodBind, this.rawMemory, debugDraw)
    }
    ...
    open fun getDebugDraw(): Viewport.DebugDraw {
        return Viewport.DebugDraw.fromInt(_icall_Int(getDebugDrawMethodBind, this.rawMemory))
    }


    private val getRenderInfoMethodBind: CPointer<godot_method_bind> by lazy { getMB("Viewport", "get_render_info") }
    open fun getRenderInfo(info: Int): Int {
    ...
    open fun setShadowAtlasSize(size: Int) {
        _icall_Unit_Int(setShadowAtlasSizeMethodBind, this.rawMemory, size)
    }


    private val getShadowAtlasSizeMethodBind: CPointer<godot_method_bind> by lazy { getMB("Viewport", "get_shadow_atlas_size") }
    open fun getShadowAtlasSize(): Int {
        return _icall_Int(getShadowAtlasSizeMethodBind, this.rawMemory)
    }
    ...
    open fun setShadowAtlasQuadrantSubdiv(quadrant: Int, subdiv: Int) {
        _icall_Unit_Int_Int(setShadowAtlasQuadrantSubdivMethodBind, this.rawMemory, quadrant, subdiv)
    }
    ...
    open fun getShadowAtlasQuadrantSubdiv(quadrant: Int): Viewport.ShadowAtlasQuadrantSubdiv {
        return Viewport.ShadowAtlasQuadrantSubdiv.fromInt(_icall_Int_Int(getShadowAtlasQuadrantSubdivMethodBind, this.rawMemory, quadrant))
    }
