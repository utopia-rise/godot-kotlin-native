...
open class VisibilityEnabler2D : VisibilityNotifier2D {
    ...
    companion object {
        ...
        const val ENABLER_PAUSE_PARTICLES: Int = 2
        const val ENABLER_PARENT_PROCESS: Int = 3
        const val ENABLER_PARENT_PHYSICS_PROCESS: Int = 4
        const val ENABLER_PAUSE_ANIMATED_SPRITES: Int = 5
        const val ENABLER_MAX: Int = 6
    ...
    open var pauseParticles: Boolean
        get() = _icall_Boolean_Int(isEnablerEnabledMethodBind, this.rawMemory, 2)
        set(value) = _icall_Unit_Int_Boolean(setEnablerMethodBind, this.rawMemory, 2, value)


    open var pauseAnimatedSprites: Boolean
        get() = _icall_Boolean_Int(isEnablerEnabledMethodBind, this.rawMemory, 5)
        set(value) = _icall_Unit_Int_Boolean(setEnablerMethodBind, this.rawMemory, 5, value)


    open var processParent: Boolean
        get() = _icall_Boolean_Int(isEnablerEnabledMethodBind, this.rawMemory, 3)
        set(value) = _icall_Unit_Int_Boolean(setEnablerMethodBind, this.rawMemory, 3, value)


    open var physicsProcessParent: Boolean
        get() = _icall_Boolean_Int(isEnablerEnabledMethodBind, this.rawMemory, 4)
        set(value) = _icall_Unit_Int_Boolean(setEnablerMethodBind, this.rawMemory, 4, value)
